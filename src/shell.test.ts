...
check(
    ...
    () => {
        ...
        for (const token of [
            ...
            "gap: 0",
            "--shell-ground: var(--surface-pane)",
            "--surface-timeline: color-mix(in srgb, var(--background-role) 75%, var(--dark-background-role))",
            "--surface-canvas: color-mix(in srgb, var(--surface-timeline) 75%, var(--darker-background-role))",
