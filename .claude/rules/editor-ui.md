...
Select gaps clear; Add previews/creates one lane/undo then Select; refusal stays Add, Escape cancels. V/A: local focus/hover, never typing/menu/gesture. Escape: field/gesture, menu, Add, precision/result, selection; Target adds no rung.
