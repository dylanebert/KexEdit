...
// UI review — the authored track + the baked F_n force curve + navigation. Point-target
// authoring (kex/specs/kex2d-force-targets.md) lands its golden-path flow in stage 2; the
// span-era flow was stripped with its UX (git holds it at 3e19820).
