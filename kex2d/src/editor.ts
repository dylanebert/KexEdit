/** ephemeral editor state — just the current selection. lives outside ECS
 *  because it doesn't persist (no save/load, no replay). plain mutable
 *  singleton; Svelte reads it via the per-RAF tick pattern in App.
 *
