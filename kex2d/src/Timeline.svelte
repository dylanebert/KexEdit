...
// scrub + zoom/pan navigation. read-only for now — force authoring is a fresh
// scope (kex/specs/kex2d-unified-solver.md → roadmap "force-authoring UX"); the
// earlier point-pin surface was stripped with the solver wiring.
