...
// R7 (S2 repair round 2, `forceHandle` surviving undo/redo when `forceEdit` survives) left with
// the force handle-edit sub-mode itself, `kex2d-segment-removal` S3 -- there is no longer a
// forceEdit/forceHandle pair for a selection-hook restore to preserve.
