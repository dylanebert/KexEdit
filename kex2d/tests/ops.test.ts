...
// the multi-section structural ops: append / delete over the section chain
// (kex2d/AGENTS.md, structural ops). the substrate (chain, sectionInfo, local
// storage) is covered in section.test.ts; this pins the ECS-authoring layer —
// chain continuity across a boundary, and the rigid-placement payoff: an
// upstream edit rigidly carries downstream. device-free.
